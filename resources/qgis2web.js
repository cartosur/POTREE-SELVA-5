...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9318177.360535, 1022087.637054, -9316424.523755, 1023363.525136], maxZoom: 20, minZoom: 10, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
...
map.getView().fit([-9318177.360535, 1022087.637054, -9316424.523755, 1023363.525136], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CURVAS DE NIVEL SELVA 5</h2>';
        return titleElement;
    })(),
